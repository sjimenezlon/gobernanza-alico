...
const KPI_SUGERIDOS: KPI[] = [
  {
    nombre: "Indice de Calidad de Datos (por dominio)",
    descripcion:
      "Mide el porcentaje de registros que cumplen las reglas de calidad definidas (completitud, precision, consistencia) en cada dominio de datos.",
  ...
  {
    nombre: "Tiempo de Resolucion de Incidentes de Datos",
    descripcion:
      "Tiempo promedio desde la deteccion de un incidente de calidad de datos hasta su correccion y cierre.",
    metaInicial: "<= 5 dias habiles",
    frecuencia: "mensual",
    responsable: "Comite Ejecutivo de Gobernanza",
    dominio: "Todos",
  },
  {
    nombre: "Porcentaje de Datos con Propietario Asignado",
    descripcion:
      "Proporcion de activos de datos criticos que tienen un Data Owner formalmente asignado y documentado.",
  ...
  {
    nombre: "Cumplimiento de Politicas de Gobernanza",
    descripcion:
      "Porcentaje de areas y procesos que cumplen con las politicas de gobernanza de datos aprobadas.",
  ...
  {
    nombre: "Disponibilidad de Datos Criticos",
    descripcion:
      "Porcentaje de tiempo en que los datos criticos estan accesibles y disponibles para los usuarios autorizados.",
    metaInicial: ">= 95%",
    frecuencia: "mensual",
  ...
  {
    nombre: "Nivel de Satisfaccion de Usuarios con Datos",
    descripcion:
      "Resultado de encuesta interna que evalua la percepcion de los usuarios sobre la calidad, accesibilidad y utilidad de los datos.",
    metaInicial: ">= 3.5 / 5.0",
  ...
  },
  {
    ...
    descripcion:
      "Proporcion de procesos de gestion de datos que cuentan con documentacion formal (procedimientos, flujos, politicas).",
      ...
      <div className="bg-white border rounded-xl p-5">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div className="bg-teal-50 rounded-lg p-3">
            ...
            <div className="text-xs text-teal-600">Medicion Mensual</div>
          </div>
